...
int main(int argc, char* argv[]){
	...
	a = 1.0/CoeficienteLagrange(limite_inferior[0],limite_inferior[1],limite_inferior[2],limite_inferior[3]);
	b = CoeficienteLagrange(limite_superior[0],limite_superior[1],limite_superior[2],limite_superior[3]);
	c = -1*CoeficienteLagrange(limite_superiorneg[0],limite_superiorneg[1],limite_superiorneg[2],limite_superiorneg[3]);
	d = -1.0/CoeficienteLagrange(limite_inferiorneg[0],limite_inferiorneg[1],limite_inferiorneg[2],limite_inferiorneg[3]);

    cout << "Melhoria no intervalo das Raízes Positivas" << endl;
	troca_de_sinal(a, b);
	
	cout << "Melhoria no intervalo das Raízes Negativas" << endl;
	troca_de_sinal(c,d);
